      ...
      <div className="quizContainer">
        {questionNumber === 0 && (
          <div>
            ...
            <h4 className="m-3">
              Want to find the next plant for your home but aren't sure where to
              start?
            </h4>
            <h4 className="m-3">
        ...
        {questionNumber === 1 && (
          <div>
            ...
            <div className="quiz">
              ...
              >
                I have a decent amount of space for this plant, like a corner of
                a room
              </button>
              <button
                className="question"
        ...
        {questionNumber === 3 && (
          <div>
            ...
            <h3 className="m-5">
              We love pets and plants and want them to coexist peacefully. <br></br>
        ...
        {questionNumber === 4 && (
          <div>
            <h1>Question Four</h1>
            <h3 className="m-5">Would you like your plant to have flowers?</h3>
            <div className="quiz">
              <button
                className="question"
